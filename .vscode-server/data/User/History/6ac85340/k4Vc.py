...
class VerboseList(list):
    ...
    Methods:
        append(self, item): Appends an item to the list with a print statement.
        extend(self, items): Extends the list with items with a print statement.
        remove(self, item): Removes an item from the list with a print statement.
        pop(self, index=-1): Removes and returns an item at the given index with a print statement.
    """
