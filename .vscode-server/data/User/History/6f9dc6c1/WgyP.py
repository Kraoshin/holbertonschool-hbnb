...
class PlaceList(Resource):
    ...
    def post(self):
        ...
        if amenities_ids:
            unexisting_amenities = [amenity_id for amenity_id in amenities_ids if not facade.get_amenity(amenity_id)]
            if unexisting_amenities:
                api.abort(400, f"Invalid amenities: {unexisting_amenities}")
