...
user_admin_update_model = api.model('User Update', {
...
review_admin_update_model = api.model('Review Update', {
...
class AdminAmenityCreate(Resource):
    @api.expect(amenity_admin_model)
...
class AdminAmenityModify(Resource):
    @api.expect(amenity_admin_update_model)
...
class AdminPlaceModify(Resource):
    @api.expect(place_admin_update_model)
...
class AdminReviewModify(Resource):
    @api.expect(review_admin_update_model)
